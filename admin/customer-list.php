		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					...
					<br>
					<a href="add-customer.php"><input type="submit" name="submit" value="Add customer" class="btn btn-primary" ></a>	
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['name'];?></td> <td><?php 
						  ...
						  </button> <button class="btn btn-primary"><a href="customer-delete.php?addid=<?php echo $row['id'];?>"onclick="return confirm('Are you sure??')">Delete</a></button>
						 </td> </tr>   <?php 
$cnt=$cnt+1;
}?></tbody> </table> 
					</div>
