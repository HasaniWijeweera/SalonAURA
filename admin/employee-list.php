			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<h4>Employee List:</h4>
						<table  id="example" class="display" style="width:100%"> <thead> <tr> <th>No</th> <th>Name</th> <th>Mobile</th> <th>Email</th> <th>Role</th>   <th>Basic Salary</th> <th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['Name'];?></td>
						  ...
						  <td><?php  echo $row['role'];?></td><td><?php  echo $row['salary'];?></td>
