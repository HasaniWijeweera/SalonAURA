			...
			<div class="main-page">
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						<h4>Employee List:</h4>
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Name</th> <th>Mobile</th> <th>Email</th> <th>Basic Salary</th>  <th>Discount Salary</th> <th>Total Salary</th> <th>Action</th> </tr> </thead> <tbody>
<?php
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['Name'];?></td>
						  <td><?php  echo $row['contactno'];?></td><td><?php  echo $row['email'];?></td> 
						   ...
						   <td><?php  echo $row['salary']+$total;?></td>
