...
<html lang="en">
	<head>
	    ...
	    <title>Salon AURA | Forgot Password</title>
...
?>
		...
		<div class="form-group">
		 ...
		 <input type="text" name="contact" class="form-control unicase-form-control text-input" id="contact" required minLength=10  maxLength=10 pattern="[0-9]+">
		</div>
<div class="form-group">
...
<div class="form-group">
		  ...
		  <div class="radio outer-xs">
		  	<a href="login.php" class="forgot-password pull-right">Back to Login</a> <br>
...
<div class="col-md-6 col-sm-6 sign-in"> <br><br><br>
<img src="assets/Orange Get Wild Bachelorette Party Invitation (1).png" class="img-fluid" alt="Colorlib Template">	</a></div>
