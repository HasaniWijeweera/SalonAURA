...
<html>
<head>
<title>Salon AURA || Customer Feedbacks</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Customer Feedbacks</h3>
					<br>
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table  id="example" class="display" style="width:100%"> <thead> <tr> <th>#</th> <th>Customer Name</th>  <th>Treatment</th>
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['name'];?></td> <td><?php  echo $row['Services'];?></td><td><?php  echo $row['quality_score'];?></td>  <td><?php  echo $row['treat_score'];?></td>
