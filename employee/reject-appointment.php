				...
				<div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<!-- <th> Appointment Number</th> -->
						 <th>Name</th><th>Service</th>  <th>Appointment Date</th><th>Appointment Time</th><th>Action</th> </tr> </thead> <tbody>
<?php
$ret=mysqli_query($con,"select *from  bookings where beautician='Dilini Randeniya' and Status='2' group by ApplyDate order by date DESC");
$cnt=1;
